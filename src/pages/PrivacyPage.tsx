      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-clay-elevated rounded-3xl shadow-clay-lg border border-white/[0.08] p-6 sm:p-10">
          ...
          <section className="mb-6">
            <h2 className="text-xl font-semibold text-clay-text mb-3">
              Introduction
            </h2>
            <p className="text-clay-text-muted leading-relaxed">
              Welcome to Which Movie To Watch. We respect your privacy and are
              committed to protecting your personal data. This privacy policy
              explains how we handle information when you use our app. We
              believe in radical transparency: we collect as little as possible,
              and what we do collect is described here in plain language.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              ...
              server. You can clear it at any time through your browser's
              settings or by clearing your localStorage.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed mb-3">
              To provide movie information and streaming data, we integrate with
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed mb-3">
              ...
              for anonymous, cookieless page view tracking. No personal
              information is collected. No cookies are set. Data cannot be
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              This app does not use cookies. All user preferences are stored in
              browser localStorage on your own device and are never transmitted
              to any server. Simple Analytics, our analytics provider, is
              likewise cookieless by design.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              This app provides links to streaming services (Netflix, Disney+,
              Amazon Prime Video, Max, Apple TV+, and others), YouTube, and
              other external websites. When you click these links, you leave our
              app and enter their platforms. We are not responsible for the
              privacy practices of these third-party services. We encourage you
              to review their privacy policies before using them.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              This app is not directed to children under the age of 13. We do
              not knowingly collect any personal information from children under
              13. If you believe a child under 13 has provided personal
              information through our service, please contact us and we will
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed mb-3">
              Since we do not collect personal data, there is no user account
              data for us to provide, delete, or export. However, you have full
              control over locally stored data:
            </p>
            <ul className="list-disc list-outside ml-5 space-y-2 text-clay-text-muted">
              <li>
                Clear your preferences at any time via your browser's developer
                tools or settings.
              </li>
              <li>
                Opt out of Simple Analytics by using a content blocker or
          ...
          <section className="mb-6">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              ...
              reflected on this page with an updated date. We encourage you to
          ...
          <section className="mb-2">
            ...
            <p className="text-clay-text-muted leading-relaxed">
              ...
              please open an issue or start a discussion on our{" "}
              <a
