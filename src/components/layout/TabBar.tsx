  ...
  return (
    <footer
      ...
      className="
        ...
        rounded-2xl
        bg-clay-base/92 sm:bg-clay-base/60 backdrop-blur-md sm:backdrop-blur-xl
    ...
    >
      <div className="flex items-center justify-between px-3 sm:px-5 py-2.5 text-xs text-clay-text-muted">
        ...
        <div className="flex items-center gap-2">
          <span className="text-2xs text-clay-text-muted hidden sm:inline">
            &copy; {year} Kohulan Rajan. All rights reserved.
          </span>
          <span className="text-2xs text-clay-text-muted sm:hidden">
            &copy; {year}
          </span>
          <span className="text-clay-text-muted/30">|</span>
          <Link
