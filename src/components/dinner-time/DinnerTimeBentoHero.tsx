            ...
            >
              ...
              <div className="relative z-10 p-5 flex flex-col justify-between h-full gap-3">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <h2 className="font-heading font-semibold text-base leading-tight text-white drop-shadow-md">
                    Family Movie Night
                  </h2>
                </div>
                ...
                <p className="text-white/80 text-sm leading-relaxed drop-shadow-sm">
                  Pick a streaming service, get a family-friendly movie pick for
                  tonight.
                </p>
              </div>
            </BentoCell>
