...
export function InstallBanner() {
  const { showPrompt, isIOS, isInstalled, install, dismiss } =
    useInstallPrompt();
              ...
              <div className="pr-6">
                ...
                <ol className="text-xs text-clay-text-muted space-y-1 list-none">
                  <li className="flex items-start gap-2">
                    <span className="font-semibold text-accent min-w-[16px]">
                      1.
                    </span>
                    <span>
                      Tap{" "}
                      <Share2 className="inline-block align-middle" size={12} />{" "}
