...
const clayShadow: Record<
  MetalButtonVariant,
  { rest: string; hover: string; tap: string }
> = {
  primary: {
    rest: buildClayShadow(
      [5, 10, 0.2],
      [2, 6, 0.06],
      [2, 5, 0.15],
      [2, 5, 0.25],
    ),
    hover: buildClayShadow(
      [7, 14, 0.25],
      [3, 8, 0.08],
      [2, 5, 0.12],
      [3, 6, 0.3],
    ),
    tap: buildClayShadow([2, 4, 0.12], [0, 0, 0.0], [4, 8, 0.2], [2, 4, 0.15]),
  },
  secondary: {
    rest: buildClayShadow(
      [4, 8, 0.18],
    ...
    tap: buildClayShadow([1, 3, 0.1], [0, 0, 0.0], [3, 6, 0.18], [2, 4, 0.12]),
  },
  ghost: {
    rest: buildClayShadow(
      [3, 6, 0.12],
    ...
    tap: buildClayShadow([1, 2, 0.08], [0, 0, 0.0], [2, 5, 0.14], [1, 3, 0.1]),
  },
};
